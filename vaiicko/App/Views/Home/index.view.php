    ...
    <div class="row">
        <div class="col mt-5">
            <div class="text-center">
                <h1 class="section-title">Vaííčko MVC FW</h1>
                <h3 class="meta-label">Version <?= App\Configuration::FW_VERSION ?></h3>
                <img src="<?= $link->asset('images/vaiicko_logo.png') ?>" alt="Framework Logo" class="mb-4">
                <p class="lead">
