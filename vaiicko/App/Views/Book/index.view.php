...
/** @var array $filters */
?>
<div class="container" data-layout="<?= htmlspecialchars(\App\Configuration::ROOT_LAYOUT) ?>">
        ...
        <div class="d-flex align-items-center gap-3">
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="btn-group" role="group" aria-label="Filter options">
                    ...
                    <label class="btn btn-outline-secondary rounded-circle" for="filterTitle" title="Názov"
                           style="width:16px;height:16px;padding:0;display:inline-block;"></label>
                    ...
                    <input type="radio" class="btn-check" name="filter" id="filterAuthor" value="author"
                           ...
                           aria-describedby="bookFilterHelp">
                    <label class="btn btn-outline-secondary rounded-circle" for="filterAuthor" title="Autor"
                           style="width:16px;height:16px;padding:0;display:inline-block;"></label>
                    ...
                    <div class="list-group-item border-bottom py-3 card-book" data-title="<?= $title ?>"
                        ...
                        <div class="row g-3 align-items-stretch">
                            <div class="col-12 col-md-2 col-lg-1 text-center">
                                <?php if (!empty($photo)): ?>
                                    <div class="bg-light d-flex align-items-center justify-content-center border rounded"
                                         style="height:100px; width:100%; min-width:80px; overflow:hidden;">
                                        <img src="<?= $photo ?>" alt="<?= $title ?>"
                                             style="max-height:100%; width:auto; display:block;">
                                    </div>
                                <?php else: ?>
                                    <div class="bg-light d-flex align-items-center justify-content-center border rounded"
                                         style="height: 100px; width: 100%; min-width: 80px;">
                            ...
                            <div class="col-12 col-lg-8">
                                ...
                                <p class="mb-2 text-secondary"><?= strlen($desc) > 200 ? substr($desc, 0, 200) . '...' : $desc ?></p>
